            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden sticky top-6">
              ...
              <div className="p-6">
                ...
                <div className=" flex flex-col gap-2 items-center w-full  ">
                  ...
                  <Link href="/contact">
                    <span className="block w-full p-4 px-24 bg-white border-2 border-green-600 text-green-700 hover:bg-green-50 text-center font-semibold  rounded-lg transition-colors">
                      Request a Quote
                    </span>
                  </Link>
                </div>
