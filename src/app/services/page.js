                ...
                <div className="flex flex-col md:flex-row h-full">
                  ...
                  <div className="w-full md:w-3/5 lg:w-2/3 p-4 md:p-6 flex flex-col h-full md:min-h-64">
                    ...
                    <div className="flex flex-wrap items-center gap-2 pt-2 border-t border-gray-100 h-12"> {/* Fixed height for buttons */}
                      <Link href={`/booknow?serviceId=${service._id || service.id}`}>
                        <span className="inline-flex items-center bg-green-600 hover:bg-green-700 text-white font-medium text-sm py-1.5 px-4 rounded-md transition-colors">
                          Book Now
                        </span>
                      </Link>
                      <Link href="/contact">
                        <span className="inline-flex items-center border border-green-600 text-green-700 hover:bg-green-50 font-medium text-sm py-1.5 px-4 rounded-md transition-colors">
                          Get Quote
                        </span>
                      </Link>
