  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const tenantData = {
        ...
        // You can expand this to include other fields like plan, features, etc.
      };
      ...
      {success && createdTenant ? (
        <div className="bg-white dark:bg-gray-800 p-6 sm:p-8 rounded-xl shadow-xl">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 mb-6">
            ...
            <div className="space-y-3">
              <div>
                <label className="block text-sm font-medium text-blue-700 dark:text-blue-300">Business Name:</label>
                <p className="text-blue-800 dark:text-blue-200 font-semibold">{createdTenant.name}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-blue-700 dark:text-blue-300">Subdomain:</label>
                <p className="text-blue-800 dark:text-blue-200 font-semibold">{createdTenant.subdomain}.localhost:3000</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-blue-700 dark:text-blue-300">Admin Email:</label>
                <p className="text-blue-800 dark:text-blue-200 font-semibold">{createdTenant.adminEmail}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-blue-700 dark:text-blue-300">Admin Password:</label>
                <p className="text-blue-800 dark:text-blue-200 font-semibold">{createdTenant.adminPassword}</p>
              </div>
            </div>
          ...
          <div className="flex justify-center space-x-4">
            ...
            <button
              ...
              className="px-6 py-2 text-sm font-semibold text-white bg-green-600 hover:bg-green-700 rounded-md transition-colors"
            >
              View All Tenants
            </button>
          </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 p-6 sm:p-8 rounded-xl shadow-xl space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <InputField label="Subdomain" name="subdomain" value={formData.subdomain} onChange={handleInputChange} error={errors.subdomain} placeholder="e.g., greenscape" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <InputField label="Admin Password" name="adminPassword" type="password" value={formData.adminPassword} onChange={handleInputChange} error={errors.adminPassword} placeholder="Minimum 8 characters" />
