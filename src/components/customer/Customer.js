            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all duration-300 scale-95 hover:scale-100">
              ...
              <div className="bg-gradient-to-r from-green-600 to-emerald-500 text-white p-5 flex justify-between items-center">
                <div>
                  ...
                  <p className="text-emerald-100 text-sm mt-1">Secure payment processing</p>
                </div>
                <button
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-gray-900">{selectedAppointment.service?.name || 'Service'}</p>
                      ...
                      <div className="mt-3 pt-3 border-t border-gray-200 flex justify-between items-center">
                        ...
                        <span className="font-bold text-lg text-emerald-600">${selectedAppointment.price || '0.00'}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {/* Credit Card */}
                    <button className={`p-3 border rounded-lg flex flex-col items-center transition-all ${paymentMethod === 'card' ? 'border-emerald-500 bg-emerald-50' : 'border-gray-200 hover:border-emerald-300'}`}
                      onClick={() => setPaymentMethod('card')}>
                      <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 mb-1 ${paymentMethod === 'card' ? 'text-emerald-600' : 'text-gray-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                      </svg>
                      <span className={`text-xs font-medium ${paymentMethod === 'card' ? 'text-emerald-700' : 'text-gray-600'}`}>Card</span>
                    </button>

                    {/* PayPal */}
                    <button className={`p-3 border rounded-lg flex flex-col items-center transition-all ${paymentMethod === 'paypal' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-blue-300'}`}
                      onClick={() => setPaymentMethod('paypal')}>
                      <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 mb-1 ${paymentMethod === 'paypal' ? 'text-blue-600' : 'text-gray-400'}`} viewBox="0 0 24 24" fill="currentColor">
                      ...
                      <span className={`text-xs font-medium ${paymentMethod === 'paypal' ? 'text-blue-700' : 'text-gray-600'}`}>PayPal</span>
                    </button>

                    {/* Bank Transfer */}
                    <button className={`p-3 border rounded-lg flex flex-col items-center transition-all ${paymentMethod === 'bank' ? 'border-purple-500 bg-purple-50' : 'border-gray-200 hover:border-purple-300'}`}
                      onClick={() => setPaymentMethod('bank')}>
                      <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 mb-1 ${paymentMethod === 'bank' ? 'text-purple-600' : 'text-gray-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3" />
                      </svg>
                      <span className={`text-xs font-medium ${paymentMethod === 'bank' ? 'text-purple-700' : 'text-gray-600'}`}>Bank</span>
                    </button>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          <label htmlFor="cvv" className="block text-sm font-medium text-gray-700 mb-1 flex items-center">
                            CVV
                            <span className="ml-1" data-tooltip="3-digit code on back of card">
                    ...
                    <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
                      <div className="flex items-center mb-3">
                        <img
                          ...
                          className="h-6 mr-2"
                        />
                        <span className="font-medium text-blue-700">Pay with PayPal</span>
                      </div>

                      <p className="text-sm text-gray-600 mb-4">
                        You'll be redirected to PayPal to complete your payment securely. No PayPal account required - you can pay with your credit card through PayPal.
                      </p>
                ...
                {paymentMethod === 'bank' && (
                  <div className="space-y-4">
                    ...
                    <div className="bg-purple-50 border border-purple-100 rounded-lg p-4">
                      <div className="mb-4">
                        <h5 className="font-medium text-purple-800 mb-2">Account Information</h5>
                        <div className="space-y-2">
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-600">Bank Name:</span>
                            <span className="font-medium">Global Trust Bank</span>
                          </div>
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-600">Account Name:</span>
                            <span className="font-medium">HealthPlus Wellness Center</span>
                          </div>
                          <div className="flex justify-between text-sm">
                      ...
                      <div className="bg-white rounded-md p-3 border border-gray-200">
                        ...
                        <ul className="text-xs text-gray-600 space-y-1 list-disc list-inside">
                          ...
                          <li>Appointment will be confirmed after payment clears</li>
                          <li>Send payment receipt to payments@healthplus.com</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                ...
                <div className="pt-4">
                  <button
                    ...
                    className={`w-full font-bold py-3 px-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center ${paymentMethod === 'paypal'
